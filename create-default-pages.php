 ...
 * Run this once to create 7 pre-defined pages
 */
...
// Save pages
if (saveStorageData(STORAGE_PAGES, $pages)) {
    echo "\n✅ All default pages created successfully!\n";
    echo "\nPages created:\n";
    foreach (array_keys($defaultPages) as $slug) {
        echo "- /$slug\n";
    }
} else {
